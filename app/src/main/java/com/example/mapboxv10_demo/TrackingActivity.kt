...
class TrackingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<MapView>(R.id.mapView).getMapboxMap().loadStyleUri(
            Style.LIGHT
            ...
            .routeOptions(
                RouteOptions.builder()
                    .coordinatesList(listOf(
                        Point.fromLngLat(-73.98769207229019, 40.73253351452368), // origin
                        Point.fromLngLat(-73.99096737041614, 40.73398916007662) // destination
                    ))
        ...
        directionsClient?.enqueueCall(object : Callback<DirectionsResponse> {
            override fun onResponse(
                ...
                response.body()?.let { body ->
                    ...
                    findViewById<MapView>(R.id.mapView).getMapboxMap().getStyle { style ->
                        findViewById<MapView>(R.id.mapView).getMapboxMap().let { mapboxMap ->
                            mapboxMap.easeTo(
