...
import com.example.mapboxv10_demo.databinding.ActivityNavigationBinding
import com.example.mapboxv10_demo.databinding.DialogProgressBinding
import com.example.mapboxv10_demo.utils.ConstantsUtils
import com.example.mapboxv10_demo.utils.ConstantsUtils.locationDestination
import com.example.mapboxv10_demo.utils.ConstantsUtils.locationStart
import com.example.mapboxv10_demo.utils.LocationHandler
import com.example.mapboxv10_demo.utils.LocationHandler.isGpsEnabled
import com.example.mapboxv10_demo.utils.LocationHandler.isLocationApproved
import com.example.mapboxv10_demo.utils.MapLocation
import com.example.mapboxv10_demo.utils.ScreenUtils.getScreenHeight
        ...
        binding.btnStartNav.setOnClickListener {
            if (binding.etStartText.text.toString()
                ...
                findLocations(
                    ...
                    binding.etDestinationText.text.toString()
                )
            } else {
            ...
            try {
                ...
                if (myCurrentAddress.equals(startAddress)) {
                    ...
                    async(Dispatchers.IO + handler) {
                        val geocoder = Geocoder(this@NavigationActivity, Locale.getDefault())
                        startResponses =
                            geocoder.getFromLocationName(startAddress, 1) as List<Address>
                    ...
                    if (startResponses.isNotEmpty()) {
                        ...
                        async(Dispatchers.IO + handler) {
                            val geocoder = Geocoder(this@NavigationActivity, Locale.getDefault())
                            endResponses =
                                geocoder.getFromLocationName(endAddress, 1) as List<Address>
                            Log.d("MapInformation", "Geocoder End")
                        }.await()
